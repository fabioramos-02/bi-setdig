...
## - Falta
-- Incluir tabela de versionamento q
Introdução q
Na sessão objetivo falta falar da padronização das nomenclatura q
...
- **Modelo de branches** - Trunk Based. Utilizaremos esse modelo, por a equipe conseguir documentar todas os commits feitos no repositorio. 
